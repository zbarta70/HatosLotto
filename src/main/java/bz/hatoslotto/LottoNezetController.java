...
public class LottoNezetController implements Initializable {
    ...
    private final String WIN4 = "Négyesed van! Kezd alakulni!";
    private final String WIN5 = "Ötösöd van! Már majdnem tökéletes!";
    private final String WIN6 = "HATOSOD VAN! Gratulálok!";
...
//</editor-fold>
    ...
    private void calculate(){
        ...
        //Are they between 1-45?
        for(Integer number : userNumbers){
            if (number < MIN || number > MAX){
                alert("Minden számnak 1 és 45 között kell lennie!");
                return;
            }
        }
    ...
    private void resultCheck(ArrayList<Integer> userNumbers){
        ...
        for(int i=0;i<userNumbers.size();i++){
            if(userNumbers.get(i) == genNum1 || userNumbers.get(i) == genNum2 || userNumbers.get(i) == genNum3 || userNumbers.get(i) == genNum4 || userNumbers.get(i) == genNum5 || userNumbers.get(i) == genNum6)
                result++;
        }
        ...
        switch(result){
            ...
            case 5 : resultLabel.setText(WIN5);
                    break;
            case 6 : resultLabel.setText(WIN6);
                    break;        
        }
    }
    ...
    private int getRandomNumber(){
      ...
      if (random == genNum1 || random == genNum2 || random == genNum3 || random == genNum4 || random == genNum5 || random == genNum6){
